...
async function main() {
  ...
  const replace_contractAddress = "0x649f418470A681ddd505d6537f61Da58b58B7FD0";//your contract created
  ...
  const replace_functionArgs = ["0x00000008Ba1350e10F55a208C0C449F7d07be5B0"];//your minter address
